 ...
 */
function applySafeMigrations(database) {
  try {
    database.exec("ALTER TABLE bullet ADD COLUMN title TEXT;");
  } catch (e) {}
  try {
    database.exec("ALTER TABLE bullet ADD COLUMN image_path TEXT;");
  } catch (e) {}
  try {
    database.exec("ALTER TABLE bullet ADD COLUMN image_url TEXT;");
  } catch (e) {}
  try {
    database.exec("ALTER TABLE bullet_patch ADD COLUMN title TEXT;");
  } catch (e) {}
  try {
    database.exec("ALTER TABLE bullet_patch ADD COLUMN image_path TEXT;");
  } catch (e) {}
  try {
    database.exec("ALTER TABLE bullet_patch ADD COLUMN image_url TEXT;");
  } catch (e) {}
}
